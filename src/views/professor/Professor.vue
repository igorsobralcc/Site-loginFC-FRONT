<template>
  ...
  >
    ...
    >
      ...
      <v-toolbar-title>Tabela Professor</v-toolbar-title>
    </v-app-bar>
    <v-data-table
      :headers="headers"
      :items="professores"
          ...
          >
            <v-card>
              ...
              >
                ...
                <v-toolbar-title>Deletar Professor</v-toolbar-title>
              </v-app-bar>
          ...
          >
            <v-card>
              ...
              >
                ...
                <v-toolbar-title>Pesquisar Professor</v-toolbar-title>
              </v-app-bar>
              <v-card-text>
                <v-container>
                  <v-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteItem (item) {
        this.editedIndex = this.professor.indexOf(item.id)
      ...
      async save () {
        // this.alert = false
        const professorId = this.editedItem.id
        const data = {
        ...
        if (val === 'edit') {
          await ProfessorDataService.update(professorId, data)
            .then((res) => {
              this.alert = true
          ...
          // salvar
          await ProfessorDataService.create(data)
            .then((res) => {
              this.alert = true
      ...
      async getDataFromApi () {
        ...
        const data = await ProfessorDataService.getAllActive()
      ...
      async deleteRow (professor) {
        await ProfessorDataService.delete(professor.id)
          .then(() => {
            this.alertSave = professor.name + ' deleted success'

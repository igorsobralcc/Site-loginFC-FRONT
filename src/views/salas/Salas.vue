<template>
  ...
  >
    ...
    >
      ...
      <v-toolbar-title>Tabela Salas</v-toolbar-title>
    </v-app-bar>
    <v-data-table
      :headers="headers"
      :items="salas"
          ...
          >
            <v-card>
              ...
              >
                ...
                <v-toolbar-title>Deletar Sala</v-toolbar-title>
              </v-app-bar>
              <v-card-title class="headline">
                <strong>Tem certeza de que deseja excluir a sala</strong> <br><br> {{ sala }}?
              </v-card-title>
              <v-card-actions>
                <v-spacer />
                <v-btn
          ...
          >
            <v-card>
              ...
              >
                ...
                <v-toolbar-title>Pesquisar Sala</v-toolbar-title>
              </v-app-bar>
              <v-card-text>
                <v-container>
                  <v-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteItem (item) {
        this.editedIndex = this.salas.indexOf(item.id)
        this.editedItem = Object.assign({}, item)
      ...
      async save () {
        ...
        if (val === 'edit') {
          ...
          await SalasDataService.create(data)
            .then((res) => {
              this.alert = true
      ...
      async deleteRow (item) {
        await SalasDataService.delete(item.id)
          .then(() => {
